#!/usr/bin/env python3
"""
Optimized Event Analysis CGI Script
...
def get_events_from_database(use_fallback=False):
    ...
    if use_fallback:
        ...
        cur.execute("""
            SELECT 
                a.id, a.url, a.title, a.outlet, a.quality_score, a.published_at, 
...
<html>
<head>
    <title>K8s News Engine - Event Analysis (Optimized)</title>
    <meta charset="utf-8">
    <style>
...
<body>
    <div class="header">
        <h1>K8s News Engine - Event Analysis <span class="optimization-badge">OPTIMIZED</span></h1>
        <p>AI-powered event detection with pre-computed quality scores and event groupings</p>
        <div style="margin-top: 15px;">
            <a href="/cgi-bin/index.py" style="color: #ecf0f1; margin-right: 20px; text-decoration: none;">📰 All Articles</a>
            <a href="/cgi-bin/events.py" style="color: #ecf0f1; margin-right: 20px; text-decoration: none;">🎯 Event Analysis (Legacy)</a>
            <a href="/cgi-bin/events_optimized.py" style="color: #ecf0f1; text-decoration: none;">⚡ Event Analysis (Optimized)</a>
        </div>
    </div>
...
<pre>{str(e)}</pre>
<p><a href="/cgi-bin/events.py">Try Legacy Event Analysis</a></p>
</body>
</html>""")
